...
# Create a smaller model that matches the checkpoint structure but with fewer blocks
# to make loading and inference faster for testing
print("Setting up xLSTM config with AMD-optimized kernels...")
...
# Generate
print("Generating with AMD-optimized kernels...")
...
print(f"\nGeneration stats (AMD-optimized kernels):")
